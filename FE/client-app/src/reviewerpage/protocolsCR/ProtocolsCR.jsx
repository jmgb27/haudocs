...
const ProtocolsCR = () => {
  ...
  const [fileName, setFileName] = useState("");
   ...
   // Sample data
  const sampleData = [
      { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.1(A) Progress Report Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.2(A) Early Termination Report Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.3(A) Amendment Review Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.4(A) Protocol Deviation/Violation Report Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.5(A) Serious Adverse Event Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.5(B) Reportable Negative Events Form", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
        { Protocolnumber: "", Documentname: "HAU-IRB FORM 3.6(A) Application for Continuing Review", 
        Datesent: "", Duedate: "", Action: "Download", Upload: "Upload" },
    ];
  ...
  return (
    ...
    <h1 className='mt-[5rem] text-center text-2xl font-bold'>Protocols For Continuing Review</h1>
