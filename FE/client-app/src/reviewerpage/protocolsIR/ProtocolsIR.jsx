...
const ProtocolsIR = () => {
  ...
  const rows = [
    { id: 1, protocolnumber: '032323name', documentname: 'HAU-IRB FORM 2(B): Registration and Application Form', datesent: "03/23/23", duedate: "04/04/23", },
  ];
  ...
  return (
    ...
    <h1 className='mt-[3rem] text-center text-2xl font-bold'>Protocols For Initial Review</h1>
