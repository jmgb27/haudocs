...
const ProtocolsIR = () => {
  ...
  const [fileName, setFileName] = useState("");
   ...
   // Sample data
  const sampleData = [
      { Protocolnumber: "", Documentname: "HAU-IRB FORM 4.1(A) Protocol Assessment Form", 
  ...
  return (
    ...
    <h1 className='mt-[5rem] text-center text-2xl font-bold'>Protocols For Initial Review</h1>
